      ...
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {features.map((feature, index) => (
            <div
              key={index}
              className='bg-orange-50 dark:bg-[#121212] p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300'
            >
        ...
        <div className='mt-20 flex justify-center'>
          <div className='bg-orange-100 dark:bg-[#121212] p-8 rounded-2xl max-w-4xl'>
